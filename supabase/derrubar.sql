...
--   select * from cn_publicadores; select * from cn_inscricoes; select * from cn_fixos; select * from cn_config;
drop function if exists public.cn_acao(text, text, jsonb);
drop function if exists public.cn_estado(text, date);
drop function if exists public.cn_quem(date);
drop function if exists public.cn_senha_ok(text);
drop function if exists public.cn_segunda(date);
drop table if exists public.cn_faltas;
drop table if exists public.cn_fixos;
